        ...
        <div v-if="currentTab === 'eventos'">
          ...
          <div v-if="showEventForm" class="form-card">
            ...
            <form @submit.prevent="saveEvent">
              <div class="row">
                <input v-model="eventForm.day" placeholder="Dia (ex: 15)" required maxlength="2" class="input-small">
                <input v-model="eventForm.month" placeholder="Mês (ex: DEZ)" required maxlength="3" class="input-small">
              </div>
        ...
        <div v-if="currentTab === 'blog'">
          ...
          <div v-if="showBlogForm" class="form-card">
            ...
            <form @submit.prevent="savePost">
              ...
              <textarea v-model="blogForm.excerpt" placeholder="Resumo da postagem" rows="3" required></textarea>
...
function prepareEditEvent(ev) {
  ...
  Object.assign(eventForm, ev) // Copia dados para o form
  showEventForm.value = true
}
